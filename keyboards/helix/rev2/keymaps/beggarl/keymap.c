...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
    ...
    L_M(ESC),KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, KC_RBRC,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
    KC_MPLY, LO_S,    KC_LCTL, KC_LGUI, KC_LALT, KC_ESC,  KC_BSPC, KC_SPC,    KC_SPC,  KC_GRV,  KC_EQL,  KC_LALT, KC_RGUI, KC_ENT
